...
describe("Organize task Api / Get Folders", () => {
  ...
  it("get all the base folders", async () => {
  ...
  it("get the simple tasks inside base folders", async () => {
    const res = await request(server)
  ...
  it("get the later tasks inside base folders", async () => {
    const res = await request(server)
  ...
  it("get the awaiting tasks inside base folders", async () => {
    const res = await request(server)
  ...
  it("get the projects inside base folders", async () => {
    const res = await request(server)
  ...
  it("get the project tasks data (All Task folder)", async () => {
    const projectFormData = {
      folderId: project._id,
    };
    const res = await request(server)
